...
class Distribution:
    def __init__(self, master):
        ...
        dist = self.widgets(self, frame)
        self.plot(self, dist, frame)
        frame.pack()
    ...
    def plot(self, dist, frame):
        ...
        self.canvas.get_tk_widget().place(relx = 0.35, rely = 0.5, anchor = 'center')
        self.canvas.draw()

def main():
    root = tk.Tk()
    root.geometry('1280x768')
    root.title("Distribution Plotter")
